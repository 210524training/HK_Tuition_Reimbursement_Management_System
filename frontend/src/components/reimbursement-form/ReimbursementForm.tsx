...
import { EventType } from "../../models/reimbursement";
...
const Register: React.FC<Props> = ({ currentUser }) => {
  ...
  const handleFinalGradeChange = (e: ChangeEvent<HTMLInputElement>) => {
  ...
  const caclulateMaxRefund =  (eventCost: number, eventType: EventType | string): number => {
    let maxRefund = 0;
    switch(eventType) {
    ...
    <div className="container mt-4">
      ...
      <Form onSubmit={handleFormSubmit}>
        ...
        <Form.Group controlId="address">
          ...
          <Form.Control required onChange={handleEventLocationChange} />
        </Form.Group>
